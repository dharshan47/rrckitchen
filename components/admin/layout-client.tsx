...
const navItems: NavItem[] = [
  ...
  { href: "/admin/delivery", label: "Delivery Management", icon: Bike },
  {
    ...
    subItems: [
      ...
      {
        href: "/admin/payments/loyalty-coupons",
        label: "Loyalty Coupons",
        icon: Gift,
        permission: "MANAGE_COUPONS",
      },
      {
        href: "/admin/payments/payment-offers",
  ...
  },
  {
    ...
    subItems: [
      ...
      {
        href: "/admin/content/category-pages",
        label: "Category Pages",
        icon: ClipboardList,
        permission: "MANAGE_CMS",
      },
      {
        href: "/admin/content/cravings-popup",
        label: "Cravings Popup",
        icon: Sparkles,
        permission: "MANAGE_CMS",
      },
      {
        href: "/admin/content/kitchen-page",
        label: "Kitchen Page",
        icon: ChefHat,
        permission: "MANAGE_CMS",
      },
      {
        href: "/admin/content/menu-page",
        label: "Menu Page",
        icon: ShoppingBag,
        permission: "MANAGE_CMS",
      },
      {
        href: "/admin/content/search-page",
        label: "Search Page",
        icon: Search,
        permission: "MANAGE_CMS",
      },
...
function Sparkline({ data, color }: { data: number[]; color: string }) {
  ...
  const points = data
    .map(
      (v, i) =>
        `${(i * stepX).toFixed(1)},${(28 - ((v - min) / range) * 26).toFixed(1)}`,
    )
    .join(" ");
  return (
    <svg
...
export default function LayoutClient({
  ...
  const currentRoute = Object.keys(routePermissionMap).find((route) =>
    pathname.startsWith(route),
  );
  const requiredPermission = currentRoute
    ? routePermissionMap[currentRoute]
    : undefined;
  const hasPageAccess =
  ...
  return (
    <SidebarProvider defaultOpen={true}>
      <div className="min-h-screen bg-[#F9FAFB] flex w-full font-sans text-slate-900">
        ...
        >
          <SidebarHeader className="h-[80px] px-6 flex-row items-center gap-3 border-none pt-[22px] pb-[10px]">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[13px] text-[#6B7280] font-medium mt-1">
                Admin Panel
              </span>
            </div>
          </SidebarHeader>
                          ...
                          <CollapsibleTrigger asChild>
                            ...
                            >
                              <div className="flex items-center w-full group">
                                <item.icon
                                  className={`h-[20px] w-[20px] mr-[12px] ${isActive ? "text-[#15803D]" : "text-[#6B7280]"}`}
                                  strokeWidth={2}
                                />
                                  ...
                                  <SidebarMenuSubItem key={subItem.href}>
                                    ...
                                    >
                                      ...
                                      >
                                        {subItem.icon && (
                                          <subItem.icon
                                            className={`h-[20px] w-[20px] mr-[12px] ${isSubActive ? "text-[#15803D]" : "text-[#6B7280]"}`}
                                            strokeWidth={2}
                                          />
                                        )}
            ...
            <div className="bg-[#F0FDF4] border-none rounded-[12px] p-3 mb-2">
              ...
              {earningsTrend !== null ? (
                <p className="text-[11px] font-bold text-[#15803D] flex items-center mt-1">
                  ...
                  <span className="text-[#6B7280] font-medium ml-1">
                    vs yesterday
                  </span>
                </p>
              ) : (
                ...
                <div className="relative">
                  <Avatar className="h-8 w-8 bg-[#15803D] text-white">
                    {session.user.image ? (
                      ...
                      <AvatarFallback className="bg-[#15803D] text-white font-bold text-xs">
                        {initials}
                      </AvatarFallback>
                    )}
                  </Avatar>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="sticky top-0 z-40 bg-[#FFFFFF] border-b border-[#E5E7EB]">
                  ...
                  <div className="relative ml-2">
                    <Avatar className="h-[44px] w-[44px] bg-[#15803D] shadow-sm">
                      {session.user.image ? (
                        ...
                        <AvatarFallback className="bg-[#15803D] text-white font-bold">
                          {initials}
                        </AvatarFallback>
                      )}
                    </Avatar>
