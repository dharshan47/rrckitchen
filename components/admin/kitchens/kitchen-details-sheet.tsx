        ...
        <Tabs defaultValue="general" className="w-full flex-1 flex flex-col">
          <div className="px-6 border-b border-[#EEF2F6]">
            <TabsList className="w-full justify-start rounded-none h-12 bg-transparent p-0 space-x-6 overflow-x-auto custom-scrollbar flex-nowrap">
              <TabsTrigger value="general" className="rounded-none border-b-2 border-transparent data-[state=active]:border-[#07883F] data-[state=active]:bg-transparent px-0 data-[state=active]:shadow-none text-[13px] text-[#64748B] data-[state=active]:text-[#07883F] font-medium whitespace-nowrap">General</TabsTrigger>
              <TabsTrigger value="menu" className="rounded-none border-b-2 border-transparent data-[state=active]:border-[#07883F] data-[state=active]:bg-transparent px-0 data-[state=active]:shadow-none text-[13px] text-[#64748B] data-[state=active]:text-[#07883F] font-medium whitespace-nowrap">Menu & Cuisines</TabsTrigger>
              <TabsTrigger value="location" className="rounded-none border-b-2 border-transparent data-[state=active]:border-[#07883F] data-[state=active]:bg-transparent px-0 data-[state=active]:shadow-none text-[13px] text-[#64748B] data-[state=active]:text-[#07883F] font-medium whitespace-nowrap">Location</TabsTrigger>
              <TabsTrigger value="timings" className="rounded-none border-b-2 border-transparent data-[state=active]:border-[#07883F] data-[state=active]:bg-transparent px-0 data-[state=active]:shadow-none text-[13px] text-[#64748B] data-[state=active]:text-[#07883F] font-medium whitespace-nowrap">Timings</TabsTrigger>
              <TabsTrigger value="documents" className="rounded-none border-b-2 border-transparent data-[state=active]:border-[#07883F] data-[state=active]:bg-transparent px-0 data-[state=active]:shadow-none text-[13px] text-[#64748B] data-[state=active]:text-[#07883F] font-medium whitespace-nowrap">Documents</TabsTrigger>
              <TabsTrigger value="settings" className="rounded-none border-b-2 border-transparent data-[state=active]:border-[#07883F] data-[state=active]:bg-transparent px-0 data-[state=active]:shadow-none text-[13px] text-[#64748B] data-[state=active]:text-[#07883F] font-medium whitespace-nowrap">Settings</TabsTrigger>
            </TabsList>
          </div>
