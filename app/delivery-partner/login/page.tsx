...
export const metadata: Metadata = {
  title: "Delivery Partner Login — RrcKitchen Thanjavur",
  description: "Login to your RrcKitchen delivery partner account to manage deliveries and view assignments.",
};
