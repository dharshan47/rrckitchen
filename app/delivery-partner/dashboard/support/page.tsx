...
import { z } from "zod"
import { Ticket, Plus, RefreshCw, Send, X, Upload, Loader2, HelpCircle, Truck, User, CreditCard, Package } from "lucide-react"
...
const categories = [
  { id: "customer-order", label: "Customer Order", icon: Package },
  { id: "kitchen-partner", label: "Kitchen Partner", icon: User },
  { id: "delivery-issue", label: "Delivery Issue", icon: Truck },
  { id: "cod", label: "COD Related", icon: CreditCard },
