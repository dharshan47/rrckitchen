...
import RefundPolicyContent from "@/content/refund-policy.mdx";

export const metadata: Metadata = {
  title: "Refund Policy",
  description: "RRC Kitchen Refund & Cancellation Policy - Learn about our order cancellations and refund processes.",
};
