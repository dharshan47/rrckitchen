...
export const metadata: Metadata = {
  title: "Kitchen Partner Login — RrcKitchen Thanjavur",
  description: "Login to your RrcKitchen kitchen partner account to manage your menu, view orders, and track earnings.",
};
